...
GEM = "thrivesmart_accounts_gem"
HUMANIZED_GEM = "ThriveSmartAccountsGem"
GEM_VERSION = "0.0.1"
AUTHOR = "ThriveSmart, LLC"
EMAIL = "developers@thrivesmart.com"
HOMEPAGE = "http://www.github.com/moorage/thrivesmart_accounts_gem"
SUMMARY = "Automatically provides the URL methods (for logging in, editing account, etc). The gem also provides methods to mixin to your application's User model which will be helpful."
